...
export default function PendingAccessPage() {
  ...
  return (
    <section className="mx-auto max-w-2xl">
      <div className="rounded-[32px] border border-border bg-card/80 p-8 shadow-panel backdrop-blur">
        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-amber-400/20 bg-amber-400/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.22em] text-amber-700">
